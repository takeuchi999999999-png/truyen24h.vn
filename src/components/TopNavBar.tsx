    ...
    <header className="sticky top-0 z-50 bg-surface/90 backdrop-blur-md border-b border-accent/10 shadow-sm">
      <div className="flex items-center justify-between w-full max-w-[1200px] px-8 py-3 mx-auto">
        <div className="flex items-center gap-10">
          <Link href="/" onClick={() => onTabChange('discover')} className="flex items-center gap-2 text-primary cursor-pointer">
            <div className="size-11 overflow-hidden rounded-full shadow-lg shadow-primary/20 border-2 border-primary/20 bg-white flex items-center justify-center">
              <img src="/logo.jpg" alt="Truyen24h.vn Logo" className="size-11 object-cover" />
            </div>
            <h2 className="text-text-main text-2xl font-display font-black leading-tight tracking-tighter">Truyen24h.vn</h2>
          </Link>
